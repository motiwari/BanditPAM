#ifndef HEADERS_ALGORITHMS_BANDITPAM_V3_HPP_
#define HEADERS_ALGORITHMS_BANDITPAM_V3_HPP_
...
namespace km {
/**
 * @brief Contains all necessary BanditPAM_v3 functions
 */
    class BanditPAM_v3 : public km::KMedoids {
    public:
        /**
         * @brief Runs BanditPAM_v3 to identify a dataset's medoids.
         * 
         * @param inputData Input data to cluster
         */
        void fitBanditPAM_v3(const arma::fmat& inputData, std::optional<std::reference_wrapper<const arma::fmat>> distMat);
        ...
        /**
         * @brief Performs the BUILD step of BanditPAM_v3.
         *
        ...
        /**
        * @brief Performs the SWAP step of BanditPAM_v3.
        * 
        * Draws batch size reference points with replacement and uses the estimated
...
#endif  // HEADERS_ALGORITHMS_BANDITPAM_V3_HPP_