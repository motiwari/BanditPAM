#ifndef HEADERS_ALGORITHMS_BANDITPAM_P_HPP_
#define HEADERS_ALGORITHMS_BANDITPAM_P_HPP_
...
namespace km {
/**
 * @brief Contains all necessary BanditPAM_p functions
 */
class BanditPAM_p : public km::KMedoids {
 public:
  /**
   * @brief Runs BanditPAM_p to identify a dataset's medoids.
   * 
  ...
  /**
   * @brief Performs the BUILD step of BanditPAM_p.
   *
  ...
  /**
  * @brief Performs the SWAP step of BanditPAM_p.
  * 
  * Draws batch size reference points with replacement and uses the estimated
...
#endif  // HEADERS_ALGORITHMS_BANDITPAM_P_HPP_
