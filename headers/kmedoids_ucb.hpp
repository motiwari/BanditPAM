...
public:
     ...
     * 
     * @param data column major dataset that the kmedoids algorithm will be run on
     * @param clusters number of clusters to fit data to
     * @param assignments vector which indicates the cluster that data point i belonds to
...
private:
     ...
     * 
     * @param data column major dataset that the kmedoids algorithm will be run on
     * @param best_distances vector containing the minimum distance between point i
     * and a medoid
     * @param sigma vector containing the sigmas for setting point i to be the next medoid
     * @param batch_size batch size used in calcuating sigma
     * @param use_absolute boolean valute indicating whether to use absolute loss or difference
     * of loss. Set to true on first iteration, false after.
     */
    void build_sigma(
        const arma::mat &data,
     ...
     * 
     * This method calculates an estimate for the loss of the points specified in target
     * using batch_size number of points.
     * 
     * @param data column major dataset that the kmedoids algorithim will be run on
     ...
     * @param use_absolute boolean valute indicating whether to use absolute loss or difference
     * of loss. Set to true on first iteration, false after.
     * @return arma::rowvec containing the estimates of the loss for the target points
     */
     ...
     * @param medoids matrix containing the selected medoids in column major format
     */
    ...
    /**
     * @brief calculate estimates of the difference in loss for targets in the swap step
     * 
     * @param data column major dataset that the kmedoids algorithim will be run on
     ...
     * @param second_best_distances second smallest distance between point i and a medoid
     * @param assignments vector containing the current cluster assignments for each data point
     * @return arma::vec containing the estimates of loss difference for the specified targets.
     */
     ...
     * @param data column major dataset that the kmedoids algorithim will be run on
     * @param clusters number of clusters to fit data to
     * @param medoid_indicies indiceies of data points that are serving as medoids
    ...
    /**
     * @brief debugging function for checking absolute loss of some given medoid_indices
     * 
     ...
     * 
     * @param data column major dataset
     * @param sigma vector of std deviation of loss difference for each iteration
     * @param batch_size number of reference points to use in estimate of loss difference
     * @param best_distances minimum distance between a point and and medoid
     * @param second_best_distances second best distance between a point and any medoid
     * @param assignments vector containing the current cluster assignments for each data point
     */
    void swap_sigma(
        const arma::mat &data,
