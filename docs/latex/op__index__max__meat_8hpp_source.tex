\hypertarget{op__index__max__meat_8hpp_source}{}\doxysection{op\+\_\+index\+\_\+max\+\_\+meat.\+hpp}
\label{op__index__max__meat_8hpp_source}\index{/Users/motiwari/Desktop/BanditPAM/headers/carma/extern/armadillo-\/code/include/armadillo\_bits/op\_index\_max\_meat.hpp@{/Users/motiwari/Desktop/BanditPAM/headers/carma/extern/armadillo-\/code/include/armadillo\_bits/op\_index\_max\_meat.hpp}}
...
\DoxyCodeLine{25 op\_index\_max::apply(\mbox{\hyperlink{classMat}{Mat<uword>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classmtOp}{mtOp<uword,T1,op\_index\_max>}}\& in)}
\DoxyCodeLine{26   \{}
...
\DoxyCodeLine{32   arma\_debug\_check( (dim > 1), \textcolor{stringliteral}{"{}index\_max(): parameter 'dim' must be 0 or 1"{}} );}
\DoxyCodeLine{33   }
...
\DoxyCodeLine{38     \{}
\DoxyCodeLine{39     op\_index\_max::apply\_noalias(out, X, dim);}
\DoxyCodeLine{40     \}}
\DoxyCodeLine{41   \textcolor{keywordflow}{else}}
\DoxyCodeLine{42     \{}
\DoxyCodeLine{43     \mbox{\hyperlink{classMat}{Mat<uword>}} tmp;}
\DoxyCodeLine{44     }
\DoxyCodeLine{45     op\_index\_max::apply\_noalias(tmp, X, dim);}
\DoxyCodeLine{46     }
...
\DoxyCodeLine{56 op\_index\_max::apply\_noalias(\mbox{\hyperlink{classMat}{Mat<uword>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classMat}{Mat<eT>}}\& X, \textcolor{keyword}{const} uword dim)}
\DoxyCodeLine{57   \{}
...
\DoxyCodeLine{66     \{}
\DoxyCodeLine{67     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_index\_max::apply(): dim = 0"{}});}
\DoxyCodeLine{68     }
...
\DoxyCodeLine{76       \{}
\DoxyCodeLine{77       op\_max::direct\_max( X.colptr(col), X\_n\_rows, out\_mem[col] );}
\DoxyCodeLine{78       \}}
\DoxyCodeLine{79     \}}
\DoxyCodeLine{80   \textcolor{keywordflow}{else}}
\DoxyCodeLine{81   \textcolor{keywordflow}{if}(dim == 1)}
\DoxyCodeLine{82     \{}
\DoxyCodeLine{83     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_index\_max::apply(): dim = 1"{}});}
\DoxyCodeLine{84     }
...
\DoxyCodeLine{114         \{}
\DoxyCodeLine{115         T\& max\_val = tmp\_mem[row];}
...
\DoxyCodeLine{117         }
\DoxyCodeLine{118         \textcolor{keywordflow}{if}(max\_val < col\_val)}
\DoxyCodeLine{119           \{}
\DoxyCodeLine{120           max\_val = col\_val;}
\DoxyCodeLine{121           }
...
\DoxyCodeLine{134 op\_index\_max::apply(\mbox{\hyperlink{classCube}{Cube<uword>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classmtOpCube}{mtOpCube<uword, T1, op\_index\_max>}}\& in)}
\DoxyCodeLine{135   \{}
...
\DoxyCodeLine{139   arma\_debug\_check( (dim > 2), \textcolor{stringliteral}{"{}index\_max(): parameter 'dim' must be 0 or 1 or 2"{}} );}
\DoxyCodeLine{140   }
...
\DoxyCodeLine{144     \{}
\DoxyCodeLine{145     op\_index\_max::apply\_noalias(out, U.M, dim);}
\DoxyCodeLine{146     \}}
\DoxyCodeLine{147   \textcolor{keywordflow}{else}}
\DoxyCodeLine{148     \{}
\DoxyCodeLine{149     \mbox{\hyperlink{classCube}{Cube<uword>}} tmp;}
\DoxyCodeLine{150     }
\DoxyCodeLine{151     op\_index\_max::apply\_noalias(tmp, U.M, dim);}
\DoxyCodeLine{152     }
...
\DoxyCodeLine{162 op\_index\_max::apply\_noalias(\mbox{\hyperlink{classCube}{Cube<uword>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classCube}{Cube<eT>}}\& X, \textcolor{keyword}{const} uword dim, \textcolor{keyword}{const} \textcolor{keyword}{typename} arma\_not\_cx<eT>::result* junk)}
\DoxyCodeLine{163   \{}
...
\DoxyCodeLine{172     \{}
\DoxyCodeLine{173     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_index\_max::apply(): dim = 0"{}});}
\DoxyCodeLine{174     }
...
\DoxyCodeLine{184         \{}
\DoxyCodeLine{185         op\_max::direct\_max( X.slice\_colptr(\mbox{\hyperlink{classslice}{slice}},col), X\_n\_rows, out\_mem[col] );}
\DoxyCodeLine{186         \}}
\DoxyCodeLine{187       \}}
\DoxyCodeLine{188     \}}
...
\DoxyCodeLine{191     \{}
\DoxyCodeLine{192     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_index\_max::apply(): dim = 1"{}});}
\DoxyCodeLine{193     }
...
\DoxyCodeLine{227     \{}
\DoxyCodeLine{228     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_index\_max::apply(): dim = 2"{}});}
\DoxyCodeLine{229     }
...
\DoxyCodeLine{264 op\_index\_max::apply\_noalias(\mbox{\hyperlink{classCube}{Cube<uword>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classCube}{Cube<eT>}}\& X, \textcolor{keyword}{const} uword dim, \textcolor{keyword}{const} \textcolor{keyword}{typename} \mbox{\hyperlink{structarma__cx__only}{arma\_cx\_only<eT>::result}}* junk)}
\DoxyCodeLine{265   \{}
...
\DoxyCodeLine{276     \{}
\DoxyCodeLine{277     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_index\_max::apply(): dim = 0"{}});}
\DoxyCodeLine{278     }
...
\DoxyCodeLine{288         \{}
\DoxyCodeLine{289         op\_max::direct\_max( X.slice\_colptr(\mbox{\hyperlink{classslice}{slice}},col), X\_n\_rows, out\_mem[col] );}
\DoxyCodeLine{290         \}}
\DoxyCodeLine{291       \}}
\DoxyCodeLine{292     \}}
...
\DoxyCodeLine{295     \{}
\DoxyCodeLine{296     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_index\_max::apply(): dim = 1"{}});}
\DoxyCodeLine{297     }
...
\DoxyCodeLine{336     \{}
\DoxyCodeLine{337     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_index\_max::apply(): dim = 2"{}});}
\DoxyCodeLine{338     }
...
\DoxyCodeLine{380 op\_index\_max::apply(\mbox{\hyperlink{classMat}{Mat<uword>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{structSpBase}{SpBase<typename T1::elem\_type,T1>}}\& expr, \textcolor{keyword}{const} uword dim)}
\DoxyCodeLine{381   \{}
...
\DoxyCodeLine{385   }
\DoxyCodeLine{386   arma\_debug\_check( (dim > 1), \textcolor{stringliteral}{"{}index\_max(): parameter 'dim' must be 0 or 1"{}} );}
\DoxyCodeLine{387   }
...
\DoxyCodeLine{395     \{}
\DoxyCodeLine{396     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_index\_max::apply(): dim = 0"{}});}
\DoxyCodeLine{397     }
...
\DoxyCodeLine{405       \{}
\DoxyCodeLine{406       out\_mem[col] = X.col(col).index\_max();}
\DoxyCodeLine{407       \}}
\DoxyCodeLine{408     \}}
\DoxyCodeLine{409   \textcolor{keywordflow}{else}}
\DoxyCodeLine{410   \textcolor{keywordflow}{if}(dim == 1)}
\DoxyCodeLine{411     \{}
\DoxyCodeLine{412     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_index\_max::apply(): dim = 1"{}});}
\DoxyCodeLine{413     }
...
\DoxyCodeLine{423       \{}
\DoxyCodeLine{424       out\_mem[row] = Xt.col(row).index\_max();}
\DoxyCodeLine{425       \}}
\DoxyCodeLine{426     \}}
\DoxyCodeLine{427   \}}
\DoxyCodeLine{428 }
