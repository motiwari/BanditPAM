\hypertarget{spglue__min__meat_8hpp_source}{}\doxysection{spglue\+\_\+min\+\_\+meat.\+hpp}
\label{spglue__min__meat_8hpp_source}\index{/Users/motiwari/Desktop/BanditPAM/headers/carma/extern/armadillo-\/code/include/armadillo\_bits/spglue\_min\_meat.hpp@{/Users/motiwari/Desktop/BanditPAM/headers/carma/extern/armadillo-\/code/include/armadillo\_bits/spglue\_min\_meat.hpp}}
...
\DoxyCodeLine{25 spglue\_min::apply(\mbox{\hyperlink{classSpMat}{SpMat<typename T1::elem\_type>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classSpGlue}{SpGlue<T1,T2,spglue\_min>}}\& X)}
\DoxyCodeLine{26   \{}
...
\DoxyCodeLine{37     \{}
\DoxyCodeLine{38     spglue\_min::apply\_noalias(out, pa, pb);}
\DoxyCodeLine{39     \}}
\DoxyCodeLine{40   \textcolor{keywordflow}{else}}
\DoxyCodeLine{41     \{}
\DoxyCodeLine{42     \mbox{\hyperlink{classSpMat}{SpMat<eT>}} tmp;}
\DoxyCodeLine{43     }
\DoxyCodeLine{44     spglue\_min::apply\_noalias(tmp, pa, pb);}
\DoxyCodeLine{45     }
...
\DoxyCodeLine{55 spglue\_min::apply\_noalias(\mbox{\hyperlink{classSpMat}{SpMat<eT>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classSpProxy}{SpProxy<T1>}}\& pa, \textcolor{keyword}{const} \mbox{\hyperlink{classSpProxy}{SpProxy<T2>}}\& pb)}
\DoxyCodeLine{56   \{}
\DoxyCodeLine{57   arma\_extra\_debug\_sigprint();}
\DoxyCodeLine{58   }
\DoxyCodeLine{59   arma\_debug\_assert\_same\_size(pa.get\_n\_rows(), pa.get\_n\_cols(), pb.get\_n\_rows(), pb.get\_n\_cols(), \textcolor{stringliteral}{"{}element-\/wise minimum"{}});}
\DoxyCodeLine{60   }
...
\DoxyCodeLine{88       \{}
\DoxyCodeLine{89       out\_val = elem\_min(eT(*x\_it), eT(*y\_it));}
\DoxyCodeLine{90       }
...
\DoxyCodeLine{97         \{}
\DoxyCodeLine{98         out\_val = elem\_min(eT(*x\_it), eT(0));}
\DoxyCodeLine{99         }
\DoxyCodeLine{100         ++x\_it;}
\DoxyCodeLine{101         \}}
\DoxyCodeLine{102       \textcolor{keywordflow}{else}}
\DoxyCodeLine{103         \{}
\DoxyCodeLine{104         out\_val = elem\_min(eT(*y\_it), eT(0));}
\DoxyCodeLine{105 }
...
\DoxyCodeLine{122       \}}
\DoxyCodeLine{123     }
\DoxyCodeLine{124     \mbox{\hyperlink{group__debug_ga458beb676810b1e43df9f0668359e76f}{arma\_check}}( (count > max\_n\_nonzero), \textcolor{stringliteral}{"{}internal error: spglue\_min::apply\_noalias(): count > max\_n\_nonzero"{}} );}
\DoxyCodeLine{125     \}}
\DoxyCodeLine{126   }
...
\DoxyCodeLine{158 spglue\_min::apply\_noalias(\mbox{\hyperlink{classSpMat}{SpMat<eT>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classSpMat}{SpMat<eT>}}\& \mbox{\hyperlink{structA}{A}}, \textcolor{keyword}{const} \mbox{\hyperlink{classSpMat}{SpMat<eT>}}\& \mbox{\hyperlink{structB}{B}})}
\DoxyCodeLine{159   \{}
...
\DoxyCodeLine{164   }
\DoxyCodeLine{165   spglue\_min::apply\_noalias(out, pa, pb);}
\DoxyCodeLine{166   \}}
\DoxyCodeLine{167 }
\DoxyCodeLine{168 }
\DoxyCodeLine{169 }
...
\DoxyCodeLine{173 spglue\_min::dense\_sparse\_min(\mbox{\hyperlink{classMat}{Mat<eT>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{structBase}{Base<eT,T1>}}\& X, \textcolor{keyword}{const} \mbox{\hyperlink{structSpBase}{SpBase<eT,T2>}}\& Y)}
\DoxyCodeLine{174   \{}
...
\DoxyCodeLine{184   }
\DoxyCodeLine{185   arma\_debug\_assert\_same\_size( n\_rows, n\_cols, pb.get\_n\_rows(), pb.get\_n\_cols(), \textcolor{stringliteral}{"{}element-\/wise minimum"{}} );}
\DoxyCodeLine{186   }
...
\DoxyCodeLine{191     \{}
\DoxyCodeLine{192     out.\mbox{\hyperlink{group__Mat_ga62c874c45807d7853afd231ae9f512d7}{at}}(r,c) = elem\_min(pa.at(r,c), pb.at(r,c));}
\DoxyCodeLine{193     \}}
\DoxyCodeLine{194   \}}
\DoxyCodeLine{195 }
\DoxyCodeLine{196 }
\DoxyCodeLine{197 }
\DoxyCodeLine{198 \textcolor{comment}{// min of non-\/complex elements}}
...
\DoxyCodeLine{202 spglue\_min::elem\_min(\textcolor{keyword}{const} eT\& a, \textcolor{keyword}{const} eT\& b)}
\DoxyCodeLine{203   \{}
\DoxyCodeLine{204   \textcolor{keywordflow}{return} (\mbox{\hyperlink{group__fn__min_gac69a480b4c714f7ecbb0620aaa757c8a}{std::min}})(a, b);}
\DoxyCodeLine{205   \}}
\DoxyCodeLine{206 }
\DoxyCodeLine{207 }
\DoxyCodeLine{208 }
\DoxyCodeLine{209 \textcolor{comment}{// min of complex elements}}
...
\DoxyCodeLine{213 spglue\_min::elem\_min(\textcolor{keyword}{const} eT\& a, \textcolor{keyword}{const} eT\& b)}
\DoxyCodeLine{214   \{}
