\hypertarget{op__cumprod__meat_8hpp_source}{}\doxysection{op\+\_\+cumprod\+\_\+meat.\+hpp}
\label{op__cumprod__meat_8hpp_source}\index{/Users/motiwari/Desktop/BanditPAM/headers/carma/extern/armadillo-\/code/include/armadillo\_bits/op\_cumprod\_meat.hpp@{/Users/motiwari/Desktop/BanditPAM/headers/carma/extern/armadillo-\/code/include/armadillo\_bits/op\_cumprod\_meat.hpp}}
...
\DoxyCodeLine{25 op\_cumprod::apply\_noalias(\mbox{\hyperlink{classMat}{Mat<eT>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classMat}{Mat<eT>}}\& X, \textcolor{keyword}{const} uword dim)}
\DoxyCodeLine{26   \{}
...
\DoxyCodeLine{114 op\_cumprod::apply(\mbox{\hyperlink{classMat}{Mat<typename T1::elem\_type>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classOp}{Op<T1,op\_cumprod>}}\& in)}
\DoxyCodeLine{115   \{}
...
\DoxyCodeLine{121   }
\DoxyCodeLine{122   arma\_debug\_check( (dim > 1), \textcolor{stringliteral}{"{}cumprod(): parameter 'dim' must be 0 or 1"{}} );}
\DoxyCodeLine{123   }
...
\DoxyCodeLine{129     }
\DoxyCodeLine{130     op\_cumprod::apply\_noalias(tmp, U.M, dim);}
\DoxyCodeLine{131     }
...
\DoxyCodeLine{135     \{}
\DoxyCodeLine{136     op\_cumprod::apply\_noalias(out, U.M, dim);}
\DoxyCodeLine{137     \}}
\DoxyCodeLine{138   \}}
\DoxyCodeLine{139 }
\DoxyCodeLine{140 }
...
\DoxyCodeLine{145 op\_cumprod\_vec::apply(\mbox{\hyperlink{classMat}{Mat<typename T1::elem\_type>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classOp}{Op<T1,op\_cumprod\_vec>}}\& in)}
\DoxyCodeLine{146   \{}
...
\DoxyCodeLine{158     }
\DoxyCodeLine{159     op\_cumprod::apply\_noalias(tmp, U.M, dim);}
\DoxyCodeLine{160     }
...
\DoxyCodeLine{164     \{}
\DoxyCodeLine{165     op\_cumprod::apply\_noalias(out, U.M, dim);}
\DoxyCodeLine{166     \}}
\DoxyCodeLine{167   \}}
\DoxyCodeLine{168 }
\DoxyCodeLine{169 }
