\hypertarget{spglue__minus__meat_8hpp_source}{}\doxysection{spglue\+\_\+minus\+\_\+meat.\+hpp}
\label{spglue__minus__meat_8hpp_source}\index{/Users/motiwari/Desktop/BanditPAM/headers/carma/extern/armadillo-\/code/include/armadillo\_bits/spglue\_minus\_meat.hpp@{/Users/motiwari/Desktop/BanditPAM/headers/carma/extern/armadillo-\/code/include/armadillo\_bits/spglue\_minus\_meat.hpp}}
...
\DoxyCodeLine{26 spglue\_minus::apply(\mbox{\hyperlink{classSpMat}{SpMat<typename T1::elem\_type>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classSpGlue}{SpGlue<T1,T2,spglue\_minus>}}\& X)}
\DoxyCodeLine{27   \{}
...
\DoxyCodeLine{38     \{}
\DoxyCodeLine{39     spglue\_minus::apply\_noalias(out, pa, pb);}
\DoxyCodeLine{40     \}}
\DoxyCodeLine{41   \textcolor{keywordflow}{else}}
\DoxyCodeLine{42     \{}
\DoxyCodeLine{43     \mbox{\hyperlink{classSpMat}{SpMat<eT>}} tmp;}
\DoxyCodeLine{44     }
\DoxyCodeLine{45     spglue\_minus::apply\_noalias(tmp, pa, pb);}
\DoxyCodeLine{46     }
...
\DoxyCodeLine{57 spglue\_minus::apply\_noalias(\mbox{\hyperlink{classSpMat}{SpMat<eT>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classSpProxy}{SpProxy<T1>}}\& pa, \textcolor{keyword}{const} \mbox{\hyperlink{classSpProxy}{SpProxy<T2>}}\& pb)}
\DoxyCodeLine{58   \{}
\DoxyCodeLine{59   arma\_extra\_debug\_sigprint();}
\DoxyCodeLine{60   }
\DoxyCodeLine{61   arma\_debug\_assert\_same\_size(pa.get\_n\_rows(), pa.get\_n\_cols(), pb.get\_n\_rows(), pb.get\_n\_cols(), \textcolor{stringliteral}{"{}subtraction"{}});}
\DoxyCodeLine{62   }
\DoxyCodeLine{63   \textcolor{keywordflow}{if}(pa.get\_n\_nonzero() == 0)  \{ out = pb.Q; out *= eT(-\/1); \textcolor{keywordflow}{return}; \}}
...
\DoxyCodeLine{83     }
\DoxyCodeLine{84     \textcolor{keyword}{const} uword x\_it\_row = x\_it.row();}
\DoxyCodeLine{85     \textcolor{keyword}{const} uword x\_it\_col = x\_it.col();}
\DoxyCodeLine{86     }
\DoxyCodeLine{87     \textcolor{keyword}{const} uword y\_it\_row = y\_it.row();}
\DoxyCodeLine{88     \textcolor{keyword}{const} uword y\_it\_col = y\_it.col();}
\DoxyCodeLine{89     }
...
\DoxyCodeLine{108         \{}
\DoxyCodeLine{109         out\_val = -\/(*y\_it);  \textcolor{comment}{// take the negative}}
\DoxyCodeLine{110         }
...
\DoxyCodeLine{127       \}}
\DoxyCodeLine{128     }
\DoxyCodeLine{129     \mbox{\hyperlink{group__debug_ga458beb676810b1e43df9f0668359e76f}{arma\_check}}( (count > max\_n\_nonzero), \textcolor{stringliteral}{"{}internal error: spglue\_minus::apply\_noalias(): count > max\_n\_nonzero"{}} );}
\DoxyCodeLine{130     \}}
\DoxyCodeLine{131   }
...
\DoxyCodeLine{164 spglue\_minus::apply\_noalias(\mbox{\hyperlink{classSpMat}{SpMat<eT>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classSpMat}{SpMat<eT>}}\& \mbox{\hyperlink{structA}{A}}, \textcolor{keyword}{const} \mbox{\hyperlink{classSpMat}{SpMat<eT>}}\& \mbox{\hyperlink{structB}{B}})}
\DoxyCodeLine{165   \{}
...
\DoxyCodeLine{170   }
\DoxyCodeLine{171   spglue\_minus::apply\_noalias(out, pa, pb);}
\DoxyCodeLine{172   \}}
\DoxyCodeLine{173 }
\DoxyCodeLine{174 }
\DoxyCodeLine{175 }
...
\DoxyCodeLine{183 spglue\_minus\_mixed::apply(\mbox{\hyperlink{classSpMat}{SpMat}}<\textcolor{keyword}{typename} eT\_promoter<T1,T2>::eT>\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classmtSpGlue}{mtSpGlue}}<\textcolor{keyword}{typename} eT\_promoter<T1,T2>::eT, T1, T2, \mbox{\hyperlink{classspglue__minus__mixed}{spglue\_minus\_mixed}}>\& expr)}
\DoxyCodeLine{184   \{}
...
\DoxyCodeLine{256 spglue\_minus\_mixed::sparse\_minus\_dense(\mbox{\hyperlink{classMat}{Mat}}< \textcolor{keyword}{typename} promote\_type<typename T1::elem\_type, typename T2::elem\_type >::result>\& out, \textcolor{keyword}{const} T1\& X, \textcolor{keyword}{const} T2\& Y)}
\DoxyCodeLine{257   \{}
...
\DoxyCodeLine{266   }
\DoxyCodeLine{267   \textcolor{keyword}{const} \mbox{\hyperlink{structquasi__unwrap}{quasi\_unwrap<T2>}} UB(Y);}
\DoxyCodeLine{268   \textcolor{keyword}{const} \mbox{\hyperlink{classMat}{Mat<eT2>}}\& \mbox{\hyperlink{structB}{B}}    = UB.M;}
\DoxyCodeLine{269   }
\DoxyCodeLine{270   \textcolor{keyword}{const} uword B\_n\_elem = \mbox{\hyperlink{structB}{B}}.n\_elem;}
\DoxyCodeLine{271   \textcolor{keyword}{const} eT2*  B\_mem    = \mbox{\hyperlink{structB}{B}}.memptr();}
\DoxyCodeLine{272   }
\DoxyCodeLine{273   out.set\_size(\mbox{\hyperlink{structB}{B}}.n\_rows, \mbox{\hyperlink{structB}{B}}.n\_cols);}
\DoxyCodeLine{274   }
\DoxyCodeLine{275   out\_eT* out\_mem = out.memptr();}
\DoxyCodeLine{276   }
\DoxyCodeLine{277   \textcolor{keywordflow}{for}(uword i=0; i<B\_n\_elem; ++i)}
\DoxyCodeLine{278     \{}
\DoxyCodeLine{279     out\_mem[i] = out\_eT(-\/B\_mem[i]);}
\DoxyCodeLine{280     \}}
\DoxyCodeLine{281   }
\DoxyCodeLine{282   \textcolor{keyword}{const} \mbox{\hyperlink{classSpProxy}{SpProxy<T1>}} pa(X);}
\DoxyCodeLine{283   }
\DoxyCodeLine{284   arma\_debug\_assert\_same\_size( pa.get\_n\_rows(), pa.get\_n\_cols(), out.\mbox{\hyperlink{classSpMat_a84c06dc8c923afc6e779fd6ab79b4c26}{n\_rows}}, out.\mbox{\hyperlink{classSpMat_a4f01c9d35f90eb836c6be489605052dd}{n\_cols}}, \textcolor{stringliteral}{"{}subtraction"{}} );}
\DoxyCodeLine{285   }
\DoxyCodeLine{286   \textcolor{keyword}{typename} \mbox{\hyperlink{classSpProxy}{SpProxy<T1>::const\_iterator\_type}} it     = pa.begin();}
\DoxyCodeLine{287   \textcolor{keyword}{typename} \mbox{\hyperlink{classSpProxy}{SpProxy<T1>::const\_iterator\_type}} it\_end = pa.end();}
\DoxyCodeLine{288   }
\DoxyCodeLine{289   \textcolor{keywordflow}{while}(it != it\_end)}
\DoxyCodeLine{290     \{}
\DoxyCodeLine{291     out.at(it.row(), it.col()) += out\_eT(*it);}
\DoxyCodeLine{292     ++it;}
\DoxyCodeLine{293     \}}
\DoxyCodeLine{294   \}}
\DoxyCodeLine{295 }
...
\DoxyCodeLine{301 spglue\_minus\_mixed::dense\_minus\_sparse(\mbox{\hyperlink{classMat}{Mat}}< \textcolor{keyword}{typename} promote\_type<typename T1::elem\_type, typename T2::elem\_type >::result>\& out, \textcolor{keyword}{const} T1\& X, \textcolor{keyword}{const} T2\& Y)}
\DoxyCodeLine{302   \{}
\DoxyCodeLine{303   arma\_extra\_debug\_sigprint();}
\DoxyCodeLine{304   }
\DoxyCodeLine{305   \textcolor{keyword}{typedef} \textcolor{keyword}{typename} T1::elem\_type eT1;}
\DoxyCodeLine{306   \textcolor{keyword}{typedef} \textcolor{keyword}{typename} T2::elem\_type eT2;}
\DoxyCodeLine{307   }
\DoxyCodeLine{308   \textcolor{keyword}{typedef} \textcolor{keyword}{typename} promote\_type<eT1,eT2>::result out\_eT;}
\DoxyCodeLine{309   }
\DoxyCodeLine{310   \mbox{\hyperlink{structpromote__type}{promote\_type<eT1,eT2>::check}}();}
\DoxyCodeLine{311   }
\DoxyCodeLine{312   \textcolor{keywordflow}{if}(\mbox{\hyperlink{structis__same__type}{is\_same\_type<eT1,out\_eT>::no}})}
\DoxyCodeLine{313     \{}
\DoxyCodeLine{314     out = \mbox{\hyperlink{classconv__to}{conv\_to< Mat<out\_eT>}} >::from(X);}
\DoxyCodeLine{315     \}}
\DoxyCodeLine{316   \textcolor{keywordflow}{else}}
\DoxyCodeLine{317     \{}
\DoxyCodeLine{318     \textcolor{keyword}{const} \mbox{\hyperlink{structquasi__unwrap}{quasi\_unwrap<T1>}} UA(X);}
\DoxyCodeLine{319     }
\DoxyCodeLine{320     \textcolor{keyword}{const} \mbox{\hyperlink{classMat}{Mat<eT1>}}\& \mbox{\hyperlink{structA}{A}} = UA.M;}
\DoxyCodeLine{321     }
\DoxyCodeLine{322     out = \textcolor{keyword}{reinterpret\_cast<} \textcolor{keyword}{const }\mbox{\hyperlink{classMat}{Mat<out\_eT>}}\& \textcolor{keyword}{>}(\mbox{\hyperlink{structA}{A}});}
\DoxyCodeLine{323     \}}
\DoxyCodeLine{324   }
\DoxyCodeLine{325   \textcolor{keyword}{const} \mbox{\hyperlink{classSpProxy}{SpProxy<T2>}} pb(Y);}
\DoxyCodeLine{326   }
\DoxyCodeLine{327   arma\_debug\_assert\_same\_size( out.\mbox{\hyperlink{classSpMat_a84c06dc8c923afc6e779fd6ab79b4c26}{n\_rows}}, out.\mbox{\hyperlink{classSpMat_a4f01c9d35f90eb836c6be489605052dd}{n\_cols}}, pb.get\_n\_rows(), pb.get\_n\_cols(), \textcolor{stringliteral}{"{}subtraction"{}} );}
\DoxyCodeLine{328   }
\DoxyCodeLine{329   \textcolor{keyword}{typename} \mbox{\hyperlink{classSpProxy}{SpProxy<T2>::const\_iterator\_type}} it     = pb.begin();}
\DoxyCodeLine{330   \textcolor{keyword}{typename} \mbox{\hyperlink{classSpProxy}{SpProxy<T2>::const\_iterator\_type}} it\_end = pb.end();}
\DoxyCodeLine{331   }
\DoxyCodeLine{332   \textcolor{keywordflow}{while}(it != it\_end)}
\DoxyCodeLine{333     \{}
\DoxyCodeLine{334     out.at(it.row(), it.col()) -\/= out\_eT(*it);}
\DoxyCodeLine{335     ++it;}
\DoxyCodeLine{336     \}}
\DoxyCodeLine{337   \}}
\DoxyCodeLine{338 }
