This repo contains a high-\/performance implementation of \mbox{\hyperlink{classBanditPAM}{Bandit\+PAM}} from \href{https://arxiv.org/abs/2006.06856}{\texttt{ Bandit\+PAM\+: Almost Linear-\/\+Time k-\/\+Medoids Clustering}}. The code can be called directly from Python or C++.
...
Documentation for \mbox{\hyperlink{classBanditPAM}{Bandit\+PAM}} can be found here\+:
\begin{DoxyItemize}
...
This will create an executable named {\ttfamily \mbox{\hyperlink{classBanditPAM}{Bandit\+PAM}}} in {\ttfamily Bandit\+PAM/build/src}.
...
\item CARMA \texorpdfstring{$>$}{>}= 0.\+3.\+0, \href{https://github.com/RUrlus/carma}{\texttt{ https\+://github.\+com/\+RUrlus/carma}} (use the commit to which {\ttfamily \mbox{\hyperlink{classBanditPAM}{Bandit\+PAM}}} points in the {\ttfamily /headers} subdirectory)
\end{DoxyItemize}
...
Mo Tiwari wrote the original Python implementation of \mbox{\hyperlink{classBanditPAM}{Bandit\+PAM}} and many features of the C++ implementation. Mo now maintains the C++ implementation.

James Mayclin developed the initial C++ implementation of \mbox{\hyperlink{classBanditPAM}{Bandit\+PAM}}.

The original \mbox{\hyperlink{classBanditPAM}{Bandit\+PAM}} paper was published by Mo Tiwari, Martin Jinye Zhang, James Mayclin, Sebastian Thrun, Chris Piech, and Ilan Shomorony.
