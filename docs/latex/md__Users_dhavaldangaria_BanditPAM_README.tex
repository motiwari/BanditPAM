...
\DoxyCodeLine{kmed.fit(X, \textcolor{stringliteral}{'L2'}, \textcolor{stringliteral}{"{}gmm\_log"{}})}
\DoxyCodeLine{}
...
\DoxyCodeLine{kmed.fit(X, \textcolor{stringliteral}{'L2'}, \textcolor{stringliteral}{"{}mnist\_log"{}})}
\DoxyCodeLine{}
...
\item Armadillo $>$= 10.\+5.\+3, \href{http://arma.sourceforge.net/download.html}{\texttt{ http\+://arma.\+sourceforge.\+net/download.\+html}}
...
\DoxyCodeLine{/BanditPAM/headers/carma/build\$ cmake .. \&\& make \&\& make sudo install}
...
\item Installation information for Mac\+OS\+: \href{https://github.com/ThrunGroup/BanditPAM/blob/main/docs/install_mac.md}{\texttt{ https\+://github.\+com/\+Thrun\+Group/\+Bandit\+PAM/blob/main/docs/install\+\_\+mac.\+md}}
\item Installation information for Linux\+: \href{https://github.com/ThrunGroup/BanditPAM/blob/main/docs/install_linux.md}{\texttt{ https\+://github.\+com/\+Thrun\+Group/\+Bandit\+PAM/blob/main/docs/install\+\_\+linux.\+md}}
\item Installation information for Windows\+: \href{https://github.com/ThrunGroup/BanditPAM/blob/main/docs/install_windows.md}{\texttt{ https\+://github.\+com/\+Thrun\+Group/\+Bandit\+PAM/blob/main/docs/install\+\_\+windows.\+md}}
\end{DoxyItemize}

\doxysubsection*{Credits}

Mo Tiwari wrote the original Python implementation of Bandit\+PAM and now maintains the C++ implementation.
