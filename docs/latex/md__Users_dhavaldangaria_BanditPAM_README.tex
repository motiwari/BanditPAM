...
\doxysection*{TL;DR This repo requires Python3, and can be easily installed via {\ttfamily pip install Bandit\+PAM}.}

If you\textquotesingle{}re on Mac or Windows and have any issue, please see the documents below and file an issue if you have additional trouble.


\begin{DoxyItemize}
\item \href{https://github.com/ThrunGroup/BanditPAM/blob/main/docs/install_mac.md}{\texttt{ Installation on Mac\+OS}}
\item \href{https://github.com/ThrunGroup/BanditPAM/blob/main/docs/install_linux.md}{\texttt{ Installation on Linux}}
\item \href{https://github.com/ThrunGroup/BanditPAM/blob/main/docs/install_windows.md}{\texttt{ Installation on Windows}}
\end{DoxyItemize}
...
\item CARMA $>$= 0.\+3.\+0, \href{https://github.com/RUrlus/carma}{\texttt{ https\+://github.\+com/\+RUrlus/carma}} (use the commit to which {\ttfamily Bandit\+PAM} points in the {\ttfamily /headers} subdirectory)
\end{DoxyItemize}
