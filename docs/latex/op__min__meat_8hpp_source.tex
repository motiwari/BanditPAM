\hypertarget{op__min__meat_8hpp_source}{}\doxysection{op\+\_\+min\+\_\+meat.\+hpp}
\label{op__min__meat_8hpp_source}\index{/Users/motiwari/Desktop/BanditPAM/headers/carma/extern/armadillo-\/code/include/armadillo\_bits/op\_min\_meat.hpp@{/Users/motiwari/Desktop/BanditPAM/headers/carma/extern/armadillo-\/code/include/armadillo\_bits/op\_min\_meat.hpp}}
...
\DoxyCodeLine{25 op\_min::apply(\mbox{\hyperlink{classMat}{Mat<typename T1::elem\_type>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classOp}{Op<T1,op\_min>}}\& in)}
\DoxyCodeLine{26   \{}
...
\DoxyCodeLine{32   arma\_debug\_check( (dim > 1), \textcolor{stringliteral}{"{}min(): parameter 'dim' must be 0 or 1"{}} );}
\DoxyCodeLine{33   }
...
\DoxyCodeLine{38     \{}
\DoxyCodeLine{39     op\_min::apply\_noalias(out, X, dim);}
\DoxyCodeLine{40     \}}
\DoxyCodeLine{41   \textcolor{keywordflow}{else}}
\DoxyCodeLine{42     \{}
\DoxyCodeLine{43     \mbox{\hyperlink{classMat}{Mat<eT>}} tmp;}
\DoxyCodeLine{44     }
\DoxyCodeLine{45     op\_min::apply\_noalias(tmp, X, dim);}
\DoxyCodeLine{46     }
...
\DoxyCodeLine{56 op\_min::apply\_noalias(\mbox{\hyperlink{classMat}{Mat<eT>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classMat}{Mat<eT>}}\& X, \textcolor{keyword}{const} uword dim, \textcolor{keyword}{const} \textcolor{keyword}{typename} arma\_not\_cx<eT>::result* junk)}
\DoxyCodeLine{57   \{}
...
\DoxyCodeLine{65     \{}
\DoxyCodeLine{66     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_min::apply(): dim = 0"{}});}
\DoxyCodeLine{67     }
...
\DoxyCodeLine{75       \{}
\DoxyCodeLine{76       out\_mem[col] = op\_min::direct\_min( X.colptr(col), X\_n\_rows );}
\DoxyCodeLine{77       \}}
\DoxyCodeLine{78     \}}
\DoxyCodeLine{79   \textcolor{keywordflow}{else}}
\DoxyCodeLine{80   \textcolor{keywordflow}{if}(dim == 1)}
\DoxyCodeLine{81     \{}
\DoxyCodeLine{82     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_min::apply(): dim = 1"{}});}
\DoxyCodeLine{83     }
...
\DoxyCodeLine{111 op\_min::apply\_noalias(\mbox{\hyperlink{classMat}{Mat<eT>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classMat}{Mat<eT>}}\& X, \textcolor{keyword}{const} uword dim, \textcolor{keyword}{const} \textcolor{keyword}{typename} \mbox{\hyperlink{structarma__cx__only}{arma\_cx\_only<eT>::result}}* junk)}
\DoxyCodeLine{112   \{}
...
\DoxyCodeLine{120     \{}
\DoxyCodeLine{121     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_min::apply(): dim = 0"{}});}
\DoxyCodeLine{122     }
...
\DoxyCodeLine{130       \{}
\DoxyCodeLine{131       out\_mem[col] = op\_min::direct\_min( X.colptr(col), X\_n\_rows );}
\DoxyCodeLine{132       \}}
\DoxyCodeLine{133     \}}
\DoxyCodeLine{134   \textcolor{keywordflow}{else}}
\DoxyCodeLine{135   \textcolor{keywordflow}{if}(dim == 1)}
\DoxyCodeLine{136     \{}
\DoxyCodeLine{137     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_min::apply(): dim = 1"{}});}
\DoxyCodeLine{138     }
...
\DoxyCodeLine{146       \{}
\DoxyCodeLine{147       out\_mem[row] = op\_min::direct\_min( X, row );}
\DoxyCodeLine{148       \}}
\DoxyCodeLine{149     \}}
\DoxyCodeLine{150   \}}
\DoxyCodeLine{151 }
...
\DoxyCodeLine{157 op\_min::apply(\mbox{\hyperlink{classCube}{Cube<typename T1::elem\_type>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classOpCube}{OpCube<T1,op\_min>}}\& in)}
\DoxyCodeLine{158   \{}
...
\DoxyCodeLine{164   arma\_debug\_check( (dim > 2), \textcolor{stringliteral}{"{}min(): parameter 'dim' must be 0 or 1 or 2"{}} );}
\DoxyCodeLine{165   }
...
\DoxyCodeLine{169     \{}
\DoxyCodeLine{170     op\_min::apply\_noalias(out, U.M, dim);}
\DoxyCodeLine{171     \}}
\DoxyCodeLine{172   \textcolor{keywordflow}{else}}
\DoxyCodeLine{173     \{}
\DoxyCodeLine{174     \mbox{\hyperlink{classCube}{Cube<eT>}} tmp;}
\DoxyCodeLine{175     }
\DoxyCodeLine{176     op\_min::apply\_noalias(tmp, U.M, dim);}
\DoxyCodeLine{177     }
...
\DoxyCodeLine{187 op\_min::apply\_noalias(\mbox{\hyperlink{classCube}{Cube<eT>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classCube}{Cube<eT>}}\& X, \textcolor{keyword}{const} uword dim, \textcolor{keyword}{const} \textcolor{keyword}{typename} arma\_not\_cx<eT>::result* junk)}
\DoxyCodeLine{188   \{}
...
\DoxyCodeLine{197     \{}
\DoxyCodeLine{198     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_min::apply(): dim = 0"{}});}
\DoxyCodeLine{199     }
...
\DoxyCodeLine{209         \{}
\DoxyCodeLine{210         out\_mem[col] = op\_min::direct\_min( X.slice\_colptr(\mbox{\hyperlink{classslice}{slice}},col), X\_n\_rows );}
\DoxyCodeLine{211         \}}
\DoxyCodeLine{212       \}}
\DoxyCodeLine{213     \}}
...
\DoxyCodeLine{216     \{}
\DoxyCodeLine{217     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_min::apply(): dim = 1"{}});}
\DoxyCodeLine{218     }
...
\DoxyCodeLine{244     \{}
\DoxyCodeLine{245     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_min::apply(): dim = 2"{}});}
\DoxyCodeLine{246     }
...
\DoxyCodeLine{276 op\_min::apply\_noalias(\mbox{\hyperlink{classCube}{Cube<eT>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classCube}{Cube<eT>}}\& X, \textcolor{keyword}{const} uword dim, \textcolor{keyword}{const} \textcolor{keyword}{typename} \mbox{\hyperlink{structarma__cx__only}{arma\_cx\_only<eT>::result}}* junk)}
\DoxyCodeLine{277   \{}
...
\DoxyCodeLine{286     \{}
\DoxyCodeLine{287     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_min::apply(): dim = 0"{}});}
\DoxyCodeLine{288     }
...
\DoxyCodeLine{298         \{}
\DoxyCodeLine{299         out\_mem[col] = op\_min::direct\_min( X.slice\_colptr(\mbox{\hyperlink{classslice}{slice}},col), X\_n\_rows );}
\DoxyCodeLine{300         \}}
\DoxyCodeLine{301       \}}
\DoxyCodeLine{302     \}}
...
\DoxyCodeLine{305     \{}
\DoxyCodeLine{306     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_min::apply(): dim = 1"{}});}
\DoxyCodeLine{307     }
...
\DoxyCodeLine{319         \{}
\DoxyCodeLine{320         out\_mem[row] = op\_min::direct\_min(tmp, row);}
\DoxyCodeLine{321         \}}
\DoxyCodeLine{322       \}}
\DoxyCodeLine{323     \}}
...
\DoxyCodeLine{326     \{}
\DoxyCodeLine{327     arma\_extra\_debug\_print(\textcolor{stringliteral}{"{}op\_min::apply(): dim = 2"{}});}
\DoxyCodeLine{328     }
...
\DoxyCodeLine{357 eT}
\DoxyCodeLine{358 op\_min::direct\_min(\textcolor{keyword}{const} eT* \textcolor{keyword}{const} X, \textcolor{keyword}{const} uword n\_elem)}
\DoxyCodeLine{359   \{}
\DoxyCodeLine{360   arma\_extra\_debug\_sigprint();}
\DoxyCodeLine{361   }
\DoxyCodeLine{362   eT min\_val = priv::most\_pos<eT>();}
\DoxyCodeLine{363   }
...
\DoxyCodeLine{369     }
\DoxyCodeLine{370     \textcolor{keywordflow}{if}(X\_i < min\_val) \{ min\_val = X\_i; \}}
\DoxyCodeLine{371     \textcolor{keywordflow}{if}(X\_j < min\_val) \{ min\_val = X\_j; \}}
\DoxyCodeLine{372     \}}
\DoxyCodeLine{373   }
...
\DoxyCodeLine{377     }
\DoxyCodeLine{378     \textcolor{keywordflow}{if}(X\_i < min\_val) \{ min\_val = X\_i; \}}
\DoxyCodeLine{379     \}}
\DoxyCodeLine{380   }
\DoxyCodeLine{381   \textcolor{keywordflow}{return} min\_val;}
\DoxyCodeLine{382   \}}
\DoxyCodeLine{383 }
\DoxyCodeLine{384 }
\DoxyCodeLine{385 }
...
\DoxyCodeLine{388 eT}
\DoxyCodeLine{389 op\_min::direct\_min(\textcolor{keyword}{const} eT* \textcolor{keyword}{const} X, \textcolor{keyword}{const} uword n\_elem, uword\& index\_of\_min\_val)}
\DoxyCodeLine{390   \{}
\DoxyCodeLine{391   arma\_extra\_debug\_sigprint();}
\DoxyCodeLine{392   }
\DoxyCodeLine{393   eT min\_val = priv::most\_pos<eT>();}
\DoxyCodeLine{394   }
...
\DoxyCodeLine{402     }
\DoxyCodeLine{403     \textcolor{keywordflow}{if}(X\_i < min\_val)}
\DoxyCodeLine{404       \{}
\DoxyCodeLine{405       min\_val    = X\_i;}
\DoxyCodeLine{406       best\_index = i;}
\DoxyCodeLine{407       \}}
\DoxyCodeLine{408     }
\DoxyCodeLine{409     \textcolor{keywordflow}{if}(X\_j < min\_val)}
\DoxyCodeLine{410       \{}
\DoxyCodeLine{411       min\_val    = X\_j;}
...
\DoxyCodeLine{419     }
\DoxyCodeLine{420     \textcolor{keywordflow}{if}(X\_i < min\_val)}
\DoxyCodeLine{421       \{}
\DoxyCodeLine{422       min\_val    = X\_i;}
\DoxyCodeLine{423       best\_index = i;}
\DoxyCodeLine{424       \}}
\DoxyCodeLine{425     \}}
\DoxyCodeLine{426   }
\DoxyCodeLine{427   index\_of\_min\_val = best\_index;}
\DoxyCodeLine{428   }
\DoxyCodeLine{429   \textcolor{keywordflow}{return} min\_val;}
\DoxyCodeLine{430   \}}
\DoxyCodeLine{431 }
\DoxyCodeLine{432 }
\DoxyCodeLine{433 }
...
\DoxyCodeLine{436 eT}
\DoxyCodeLine{437 op\_min::direct\_min(\textcolor{keyword}{const} \mbox{\hyperlink{classMat}{Mat<eT>}}\& X, \textcolor{keyword}{const} uword row)}
\DoxyCodeLine{438   \{}
\DoxyCodeLine{439   arma\_extra\_debug\_sigprint();}
\DoxyCodeLine{440   }
\DoxyCodeLine{441   \textcolor{keyword}{const} uword X\_n\_cols = X.n\_cols;}
\DoxyCodeLine{442   }
\DoxyCodeLine{443   eT min\_val = priv::most\_pos<eT>();}
\DoxyCodeLine{444   }
...
\DoxyCodeLine{450     }
\DoxyCodeLine{451     \textcolor{keywordflow}{if}(tmp\_i < min\_val) \{ min\_val = tmp\_i; \}}
\DoxyCodeLine{452     \textcolor{keywordflow}{if}(tmp\_j < min\_val) \{ min\_val = tmp\_j; \}}
\DoxyCodeLine{453     \}}
\DoxyCodeLine{454   }
...
\DoxyCodeLine{458     }
\DoxyCodeLine{459     \textcolor{keywordflow}{if}(tmp\_i < min\_val) \{ min\_val = tmp\_i; \}}
\DoxyCodeLine{460     \}}
\DoxyCodeLine{461   }
\DoxyCodeLine{462   \textcolor{keywordflow}{return} min\_val;}
\DoxyCodeLine{463   \}}
\DoxyCodeLine{464 }
\DoxyCodeLine{465 }
\DoxyCodeLine{466 }
...
\DoxyCodeLine{469 eT}
\DoxyCodeLine{470 op\_min::min(\textcolor{keyword}{const} \mbox{\hyperlink{classsubview}{subview<eT>}}\& X)}
\DoxyCodeLine{471   \{}
\DoxyCodeLine{472   arma\_extra\_debug\_sigprint();}
\DoxyCodeLine{473   }
\DoxyCodeLine{474   \textcolor{keywordflow}{if}(X.n\_elem == 0)}
\DoxyCodeLine{475     \{}
\DoxyCodeLine{476     arma\_debug\_check(\textcolor{keyword}{true}, \textcolor{stringliteral}{"{}min(): object has no elements"{}});}
\DoxyCodeLine{477     }
...
\DoxyCodeLine{483   }
\DoxyCodeLine{484   eT min\_val = priv::most\_pos<eT>();}
\DoxyCodeLine{485   }
...
\DoxyCodeLine{500       }
\DoxyCodeLine{501       \textcolor{keywordflow}{if}(tmp\_i < min\_val) \{ min\_val = tmp\_i; \}}
\DoxyCodeLine{502       \textcolor{keywordflow}{if}(tmp\_j < min\_val) \{ min\_val = tmp\_j; \}}
\DoxyCodeLine{503       \}}
\DoxyCodeLine{504     }
...
\DoxyCodeLine{508       }
\DoxyCodeLine{509       \textcolor{keywordflow}{if}(tmp\_i < min\_val) \{ min\_val = tmp\_i; \}}
\DoxyCodeLine{510       \}}
\DoxyCodeLine{511     \}}
...
\DoxyCodeLine{515       \{}
\DoxyCodeLine{516       min\_val = (\mbox{\hyperlink{group__fn__min_gac69a480b4c714f7ecbb0620aaa757c8a}{std::min}})(min\_val, op\_min::direct\_min(X.colptr(col), X\_n\_rows));}
\DoxyCodeLine{517       \}}
\DoxyCodeLine{518     \}}
\DoxyCodeLine{519   }
\DoxyCodeLine{520   \textcolor{keywordflow}{return} min\_val;}
\DoxyCodeLine{521   \}}
\DoxyCodeLine{522 }
\DoxyCodeLine{523 }
\DoxyCodeLine{524 }
...
\DoxyCodeLine{528 op\_min::min(\textcolor{keyword}{const} \mbox{\hyperlink{structBase}{Base<typename T1::elem\_type,T1>}}\& X)}
\DoxyCodeLine{529   \{}
...
\DoxyCodeLine{539     \{}
\DoxyCodeLine{540     arma\_debug\_check(\textcolor{keyword}{true}, \textcolor{stringliteral}{"{}min(): object has no elements"{}});}
\DoxyCodeLine{541     }
\DoxyCodeLine{542     \textcolor{keywordflow}{return} \mbox{\hyperlink{classDatum}{Datum<eT>::nan}};}
\DoxyCodeLine{543     \}}
\DoxyCodeLine{544   }
\DoxyCodeLine{545   eT min\_val = priv::most\_pos<eT>();}
\DoxyCodeLine{546   }
...
\DoxyCodeLine{559       }
\DoxyCodeLine{560       \textcolor{keywordflow}{if}(tmp\_i < min\_val) \{ min\_val = tmp\_i; \}}
\DoxyCodeLine{561       \textcolor{keywordflow}{if}(tmp\_j < min\_val) \{ min\_val = tmp\_j; \}}
\DoxyCodeLine{562       \}}
\DoxyCodeLine{563     }
...
\DoxyCodeLine{567       }
\DoxyCodeLine{568       \textcolor{keywordflow}{if}(tmp\_i < min\_val) \{ min\_val = tmp\_i; \}}
\DoxyCodeLine{569       \}}
\DoxyCodeLine{570     \}}
...
\DoxyCodeLine{583         }
\DoxyCodeLine{584         \textcolor{keywordflow}{if}(tmp\_i < min\_val) \{ min\_val = tmp\_i; \}}
\DoxyCodeLine{585         \textcolor{keywordflow}{if}(tmp\_j < min\_val) \{ min\_val = tmp\_j; \}}
\DoxyCodeLine{586         \}}
\DoxyCodeLine{587       }
...
\DoxyCodeLine{591         }
\DoxyCodeLine{592         \textcolor{keywordflow}{if}(tmp\_i < min\_val) \{ min\_val = tmp\_i; \}}
\DoxyCodeLine{593         \}}
\DoxyCodeLine{594       \}}
...
\DoxyCodeLine{604           }
\DoxyCodeLine{605           \textcolor{keywordflow}{if}(tmp\_i < min\_val) \{ min\_val = tmp\_i; \}}
\DoxyCodeLine{606           \textcolor{keywordflow}{if}(tmp\_j < min\_val) \{ min\_val = tmp\_j; \}}
\DoxyCodeLine{607           \}}
\DoxyCodeLine{608           }
...
\DoxyCodeLine{612           }
\DoxyCodeLine{613           \textcolor{keywordflow}{if}(tmp\_i < min\_val) \{ min\_val = tmp\_i; \}}
\DoxyCodeLine{614           \}}
\DoxyCodeLine{615         \}}
\DoxyCodeLine{616       \}}
\DoxyCodeLine{617     \}}
\DoxyCodeLine{618   }
\DoxyCodeLine{619   \textcolor{keywordflow}{return} min\_val;}
\DoxyCodeLine{620   \}}
\DoxyCodeLine{621 }
\DoxyCodeLine{622 }
\DoxyCodeLine{623 }
...
\DoxyCodeLine{627 op\_min::min(\textcolor{keyword}{const} \mbox{\hyperlink{structBaseCube}{BaseCube<typename T1::elem\_type,T1>}}\& X)}
\DoxyCodeLine{628   \{}
...
\DoxyCodeLine{638     \{}
\DoxyCodeLine{639     arma\_debug\_check(\textcolor{keyword}{true}, \textcolor{stringliteral}{"{}min(): object has no elements"{}});}
\DoxyCodeLine{640     }
\DoxyCodeLine{641     \textcolor{keywordflow}{return} \mbox{\hyperlink{classDatum}{Datum<eT>::nan}};}
\DoxyCodeLine{642     \}}
\DoxyCodeLine{643   }
\DoxyCodeLine{644   eT min\_val = priv::most\_pos<eT>();}
\DoxyCodeLine{645   }
...
\DoxyCodeLine{658       }
\DoxyCodeLine{659       \textcolor{keywordflow}{if}(tmp\_i < min\_val) \{ min\_val = tmp\_i; \}}
\DoxyCodeLine{660       \textcolor{keywordflow}{if}(tmp\_j < min\_val) \{ min\_val = tmp\_j; \}}
\DoxyCodeLine{661       \}}
\DoxyCodeLine{662     }
...
\DoxyCodeLine{666       }
\DoxyCodeLine{667       \textcolor{keywordflow}{if}(tmp\_i < min\_val) \{ min\_val = tmp\_i; \}}
\DoxyCodeLine{668       \}}
\DoxyCodeLine{669     \}}
...
\DoxyCodeLine{681 }
\DoxyCodeLine{682       \textcolor{keywordflow}{if}(tmp < min\_val) \{ min\_val = tmp; \}}
\DoxyCodeLine{683       \}}
\DoxyCodeLine{684     \}}
\DoxyCodeLine{685   }
\DoxyCodeLine{686   \textcolor{keywordflow}{return} min\_val;}
\DoxyCodeLine{687   \}}
\DoxyCodeLine{688 }
\DoxyCodeLine{689 }
\DoxyCodeLine{690 }
...
\DoxyCodeLine{694 op\_min::min\_with\_index(\textcolor{keyword}{const} \mbox{\hyperlink{classProxy}{Proxy<T1>}}\& P, uword\& index\_of\_min\_val)}
\DoxyCodeLine{695   \{}
...
\DoxyCodeLine{703     \{}
\DoxyCodeLine{704     arma\_debug\_check(\textcolor{keyword}{true}, \textcolor{stringliteral}{"{}min(): object has no elements"{}});}
\DoxyCodeLine{705     }
\DoxyCodeLine{706     \textcolor{keywordflow}{return} \mbox{\hyperlink{classDatum}{Datum<eT>::nan}};}
\DoxyCodeLine{707     \}}
\DoxyCodeLine{708   }
\DoxyCodeLine{709   eT    best\_val   = priv::most\_pos<eT>();}
...
\DoxyCodeLine{763     \}}
\DoxyCodeLine{764   }
\DoxyCodeLine{765   index\_of\_min\_val = best\_index;}
\DoxyCodeLine{766   }
...
\DoxyCodeLine{775 op\_min::min\_with\_index(\textcolor{keyword}{const} \mbox{\hyperlink{classProxyCube}{ProxyCube<T1>}}\& P, uword\& index\_of\_min\_val)}
\DoxyCodeLine{776   \{}
...
\DoxyCodeLine{784     \{}
\DoxyCodeLine{785     arma\_debug\_check(\textcolor{keyword}{true}, \textcolor{stringliteral}{"{}min(): object has no elements"{}});}
\DoxyCodeLine{786     }
\DoxyCodeLine{787     \textcolor{keywordflow}{return} \mbox{\hyperlink{classDatum}{Datum<eT>::nan}};}
\DoxyCodeLine{788     \}}
\DoxyCodeLine{789   }
\DoxyCodeLine{790   eT    best\_val   = priv::most\_pos<eT>();}
...
\DoxyCodeLine{824     \}}
\DoxyCodeLine{825   }
\DoxyCodeLine{826   index\_of\_min\_val = best\_index;}
\DoxyCodeLine{827   }
...
\DoxyCodeLine{836 op\_min::direct\_min(\textcolor{keyword}{const} std::complex<T>* \textcolor{keyword}{const} X, \textcolor{keyword}{const} uword n\_elem)}
\DoxyCodeLine{837   \{}
\DoxyCodeLine{838   arma\_extra\_debug\_sigprint();}
\DoxyCodeLine{839   }
\DoxyCodeLine{840   uword index   = 0;}
\DoxyCodeLine{841   T     min\_val = priv::most\_pos<T>();}
\DoxyCodeLine{842   }
...
\DoxyCodeLine{846     }
\DoxyCodeLine{847     \textcolor{keywordflow}{if}(tmp\_val < min\_val)}
\DoxyCodeLine{848       \{}
\DoxyCodeLine{849       min\_val = tmp\_val;}
...
\DoxyCodeLine{862 op\_min::direct\_min(\textcolor{keyword}{const} std::complex<T>* \textcolor{keyword}{const} X, \textcolor{keyword}{const} uword n\_elem, uword\& index\_of\_min\_val)}
\DoxyCodeLine{863   \{}
\DoxyCodeLine{864   arma\_extra\_debug\_sigprint();}
\DoxyCodeLine{865   }
\DoxyCodeLine{866   uword index   = 0;}
\DoxyCodeLine{867   T     min\_val = priv::most\_pos<T>();}
\DoxyCodeLine{868   }
...
\DoxyCodeLine{872     }
\DoxyCodeLine{873     \textcolor{keywordflow}{if}(tmp\_val < min\_val)}
\DoxyCodeLine{874       \{}
\DoxyCodeLine{875       min\_val = tmp\_val;}
\DoxyCodeLine{876       index   = i;}
\DoxyCodeLine{877       \}}
\DoxyCodeLine{878     \}}
\DoxyCodeLine{879   }
\DoxyCodeLine{880   index\_of\_min\_val = index;}
\DoxyCodeLine{881   }
...
\DoxyCodeLine{890 op\_min::direct\_min(\textcolor{keyword}{const} \mbox{\hyperlink{classMat}{Mat}}< std::complex<T> >\& X, \textcolor{keyword}{const} uword row)}
\DoxyCodeLine{891   \{}
...
\DoxyCodeLine{897   T     min\_val = priv::most\_pos<T>();}
\DoxyCodeLine{898   }
...
\DoxyCodeLine{902     }
\DoxyCodeLine{903     \textcolor{keywordflow}{if}(tmp\_val < min\_val)}
\DoxyCodeLine{904       \{}
\DoxyCodeLine{905       min\_val = tmp\_val;}
...
\DoxyCodeLine{918 op\_min::min(\textcolor{keyword}{const} \mbox{\hyperlink{classsubview}{subview}}< std::complex<T> >\& X)}
\DoxyCodeLine{919   \{}
...
\DoxyCodeLine{925     \{}
\DoxyCodeLine{926     arma\_debug\_check(\textcolor{keyword}{true}, \textcolor{stringliteral}{"{}min(): object has no elements"{}});}
\DoxyCodeLine{927     }
...
\DoxyCodeLine{941   }
\DoxyCodeLine{942   T min\_val = priv::most\_pos<T>();}
\DoxyCodeLine{943   }
...
\DoxyCodeLine{954       }
\DoxyCodeLine{955       \textcolor{keywordflow}{if}(tmp\_val < min\_val)}
\DoxyCodeLine{956         \{}
\DoxyCodeLine{957         min\_val  = tmp\_val;}
...
\DoxyCodeLine{970       }
\DoxyCodeLine{971       \textcolor{keywordflow}{if}(tmp\_val < min\_val)}
\DoxyCodeLine{972         \{}
\DoxyCodeLine{973         min\_val  = tmp\_val;}
...
\DoxyCodeLine{988 op\_min::min(\textcolor{keyword}{const} \mbox{\hyperlink{structBase}{Base<typename T1::elem\_type,T1>}}\& X)}
\DoxyCodeLine{989   \{}
...
\DoxyCodeLine{1000     \{}
\DoxyCodeLine{1001     arma\_debug\_check(\textcolor{keyword}{true}, \textcolor{stringliteral}{"{}min(): object has no elements"{}});}
\DoxyCodeLine{1002     }
\DoxyCodeLine{1003     \textcolor{keywordflow}{return} \mbox{\hyperlink{classDatum}{Datum<eT>::nan}};}
\DoxyCodeLine{1004     \}}
\DoxyCodeLine{1005   }
\DoxyCodeLine{1006   T min\_val = priv::most\_pos<T>();}
\DoxyCodeLine{1007   }
...
\DoxyCodeLine{1019       }
\DoxyCodeLine{1020       \textcolor{keywordflow}{if}(tmp < min\_val)}
\DoxyCodeLine{1021         \{}
\DoxyCodeLine{1022         min\_val = tmp;}
...
\DoxyCodeLine{1042         }
\DoxyCodeLine{1043         \textcolor{keywordflow}{if}(tmp < min\_val)}
\DoxyCodeLine{1044           \{}
\DoxyCodeLine{1045           min\_val  = tmp;}
...
\DoxyCodeLine{1056         }
\DoxyCodeLine{1057         \textcolor{keywordflow}{if}(tmp < min\_val)}
\DoxyCodeLine{1058           \{}
\DoxyCodeLine{1059           min\_val = tmp;}
\DoxyCodeLine{1060           }
...
\DoxyCodeLine{1076 op\_min::min(\textcolor{keyword}{const} \mbox{\hyperlink{structBaseCube}{BaseCube<typename T1::elem\_type,T1>}}\& X)}
\DoxyCodeLine{1077   \{}
...
\DoxyCodeLine{1088     \{}
\DoxyCodeLine{1089     arma\_debug\_check(\textcolor{keyword}{true}, \textcolor{stringliteral}{"{}min(): object has no elements"{}});}
\DoxyCodeLine{1090     }
\DoxyCodeLine{1091     \textcolor{keywordflow}{return} \mbox{\hyperlink{classDatum}{Datum<eT>::nan}};}
\DoxyCodeLine{1092     \}}
\DoxyCodeLine{1093   }
\DoxyCodeLine{1094   T min\_val = priv::most\_pos<T>();}
\DoxyCodeLine{1095   }
...
\DoxyCodeLine{1107       }
\DoxyCodeLine{1108       \textcolor{keywordflow}{if}(tmp < min\_val)}
\DoxyCodeLine{1109         \{}
\DoxyCodeLine{1110         min\_val = tmp;}
...
\DoxyCodeLine{1122     }
\DoxyCodeLine{1123     eT min\_val\_orig = eT(0);}
\DoxyCodeLine{1124     }
...
\DoxyCodeLine{1131       }
\DoxyCodeLine{1132       \textcolor{keywordflow}{if}(tmp < min\_val)}
\DoxyCodeLine{1133         \{}
\DoxyCodeLine{1134         min\_val      = tmp;}
\DoxyCodeLine{1135         min\_val\_orig = tmp\_orig;}
\DoxyCodeLine{1136         \}}
\DoxyCodeLine{1137       \}}
\DoxyCodeLine{1138     }
\DoxyCodeLine{1139     \textcolor{keywordflow}{return} min\_val\_orig;}
\DoxyCodeLine{1140     \}}
\DoxyCodeLine{1141   \}}
\DoxyCodeLine{1142 }
\DoxyCodeLine{1143 }
...
\DoxyCodeLine{1148 op\_min::min\_with\_index(\textcolor{keyword}{const} \mbox{\hyperlink{classProxy}{Proxy<T1>}}\& P, uword\& index\_of\_min\_val)}
\DoxyCodeLine{1149   \{}
...
\DoxyCodeLine{1158     \{}
\DoxyCodeLine{1159     arma\_debug\_check(\textcolor{keyword}{true}, \textcolor{stringliteral}{"{}min(): object has no elements"{}});}
\DoxyCodeLine{1160     }
\DoxyCodeLine{1161     \textcolor{keywordflow}{return} \mbox{\hyperlink{classDatum}{Datum<eT>::nan}};}
\DoxyCodeLine{1162     \}}
\DoxyCodeLine{1163   }
\DoxyCodeLine{1164   T best\_val = priv::most\_pos<T>();}
\DoxyCodeLine{1165   }
...
\DoxyCodeLine{1179       \}}
\DoxyCodeLine{1180     }
\DoxyCodeLine{1181     index\_of\_min\_val = best\_index;}
\DoxyCodeLine{1182     }
...
\DoxyCodeLine{1238       \}}
\DoxyCodeLine{1239     }
\DoxyCodeLine{1240     index\_of\_min\_val = best\_index;}
\DoxyCodeLine{1241     }
...
\DoxyCodeLine{1251 op\_min::min\_with\_index(\textcolor{keyword}{const} \mbox{\hyperlink{classProxyCube}{ProxyCube<T1>}}\& P, uword\& index\_of\_min\_val)}
\DoxyCodeLine{1252   \{}
...
\DoxyCodeLine{1261     \{}
\DoxyCodeLine{1262     arma\_debug\_check(\textcolor{keyword}{true}, \textcolor{stringliteral}{"{}min(): object has no elements"{}});}
\DoxyCodeLine{1263     }
\DoxyCodeLine{1264     \textcolor{keywordflow}{return} \mbox{\hyperlink{classDatum}{Datum<eT>::nan}};}
\DoxyCodeLine{1265     \}}
\DoxyCodeLine{1266   }
\DoxyCodeLine{1267   T best\_val = priv::most\_pos<T>();}
\DoxyCodeLine{1268   }
...
\DoxyCodeLine{1282       \}}
\DoxyCodeLine{1283     }
\DoxyCodeLine{1284     index\_of\_min\_val = best\_index;}
\DoxyCodeLine{1285     }
...
\DoxyCodeLine{1313       \}}
\DoxyCodeLine{1314     }
\DoxyCodeLine{1315     index\_of\_min\_val = best\_index;}
\DoxyCodeLine{1316     }
