\hypertarget{glue__max__meat_8hpp_source}{}\doxysection{glue\+\_\+max\+\_\+meat.\+hpp}
\label{glue__max__meat_8hpp_source}\index{/Users/motiwari/Desktop/BanditPAM/headers/carma/extern/armadillo-\/code/include/armadillo\_bits/glue\_max\_meat.hpp@{/Users/motiwari/Desktop/BanditPAM/headers/carma/extern/armadillo-\/code/include/armadillo\_bits/glue\_max\_meat.hpp}}
...
\DoxyCodeLine{26 glue\_max::apply(\mbox{\hyperlink{classMat}{Mat<typename T1::elem\_type>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classGlue}{Glue<T1, T2, glue\_max>}}\& X)}
\DoxyCodeLine{27   \{}
...
\DoxyCodeLine{38     }
\DoxyCodeLine{39     glue\_max::apply(tmp, PA, PB);}
\DoxyCodeLine{40     }
...
\DoxyCodeLine{44     \{}
\DoxyCodeLine{45     glue\_max::apply(out, PA, PB);}
\DoxyCodeLine{46     \}}
\DoxyCodeLine{47   \}}
\DoxyCodeLine{48 }
\DoxyCodeLine{49 }
...
\DoxyCodeLine{54 glue\_max::apply(\mbox{\hyperlink{classMat}{Mat<eT>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classProxy}{Proxy<T1>}}\& PA, \textcolor{keyword}{const} \mbox{\hyperlink{classProxy}{Proxy<T2>}}\& PB)}
\DoxyCodeLine{55   \{}
...
\DoxyCodeLine{60   }
\DoxyCodeLine{61   arma\_debug\_assert\_same\_size(n\_rows, n\_cols, PB.get\_n\_rows(), PB.get\_n\_cols(), \textcolor{stringliteral}{"{}element-\/wise maximum"{}});}
\DoxyCodeLine{62   }
...
\DoxyCodeLine{75       \{}
\DoxyCodeLine{76       out\_mem[i] = (\mbox{\hyperlink{group__fn__max_gaf2317ac99c92ae7a239291d01a615893}{std::max}})(\mbox{\hyperlink{structA}{A}}[i], \mbox{\hyperlink{structB}{B}}[i]);}
\DoxyCodeLine{77       \}}
\DoxyCodeLine{78     \}}
...
\DoxyCodeLine{83       \{}
\DoxyCodeLine{84       *out\_mem = (\mbox{\hyperlink{group__fn__max_gaf2317ac99c92ae7a239291d01a615893}{std::max}})( PA.at(row,col), PB.at(row,col) );}
\DoxyCodeLine{85       }
...
\DoxyCodeLine{96 glue\_max::apply(\mbox{\hyperlink{classMat}{Mat}}< std::complex<T> >\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classProxy}{Proxy<T1>}}\& PA, \textcolor{keyword}{const} \mbox{\hyperlink{classProxy}{Proxy<T2>}}\& PB)}
\DoxyCodeLine{97   \{}
...
\DoxyCodeLine{104   }
\DoxyCodeLine{105   arma\_debug\_assert\_same\_size(n\_rows, n\_cols, PB.get\_n\_rows(), PB.get\_n\_cols(), \textcolor{stringliteral}{"{}element-\/wise maximum"{}});}
\DoxyCodeLine{106   }
...
\DoxyCodeLine{146 glue\_max::apply(\mbox{\hyperlink{classCube}{Cube<typename T1::elem\_type>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classGlueCube}{GlueCube<T1, T2, glue\_max>}}\& X)}
\DoxyCodeLine{147   \{}
...
\DoxyCodeLine{158     }
\DoxyCodeLine{159     glue\_max::apply(tmp, PA, PB);}
\DoxyCodeLine{160     }
...
\DoxyCodeLine{164     \{}
\DoxyCodeLine{165     glue\_max::apply(out, PA, PB);}
\DoxyCodeLine{166     \}}
\DoxyCodeLine{167   \}}
\DoxyCodeLine{168 }
\DoxyCodeLine{169 }
...
\DoxyCodeLine{174 glue\_max::apply(\mbox{\hyperlink{classCube}{Cube<eT>}}\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classProxyCube}{ProxyCube<T1>}}\& PA, \textcolor{keyword}{const} \mbox{\hyperlink{classProxyCube}{ProxyCube<T2>}}\& PB)}
\DoxyCodeLine{175   \{}
...
\DoxyCodeLine{181   }
\DoxyCodeLine{182   arma\_debug\_assert\_same\_size(n\_rows, n\_cols, n\_slices, PB.get\_n\_rows(), PB.get\_n\_cols(), PB.get\_n\_slices(), \textcolor{stringliteral}{"{}element-\/wise maximum"{}});}
\DoxyCodeLine{183   }
...
\DoxyCodeLine{196       \{}
\DoxyCodeLine{197       out\_mem[i] = (\mbox{\hyperlink{group__fn__max_gaf2317ac99c92ae7a239291d01a615893}{std::max}})(\mbox{\hyperlink{structA}{A}}[i], \mbox{\hyperlink{structB}{B}}[i]);}
\DoxyCodeLine{198       \}}
\DoxyCodeLine{199     \}}
...
\DoxyCodeLine{205       \{}
\DoxyCodeLine{206       *out\_mem = (\mbox{\hyperlink{group__fn__max_gaf2317ac99c92ae7a239291d01a615893}{std::max}})( PA.at(row,col,\mbox{\hyperlink{classslice}{slice}}), PB.at(row,col,\mbox{\hyperlink{classslice}{slice}}) );}
\DoxyCodeLine{207       }
...
\DoxyCodeLine{218 glue\_max::apply(\mbox{\hyperlink{classCube}{Cube}}< std::complex<T> >\& out, \textcolor{keyword}{const} \mbox{\hyperlink{classProxyCube}{ProxyCube<T1>}}\& PA, \textcolor{keyword}{const} \mbox{\hyperlink{classProxyCube}{ProxyCube<T2>}}\& PB)}
\DoxyCodeLine{219   \{}
...
\DoxyCodeLine{227   }
\DoxyCodeLine{228   arma\_debug\_assert\_same\_size(n\_rows, n\_cols, n\_slices, PB.get\_n\_rows(), PB.get\_n\_cols(), PB.get\_n\_slices(), \textcolor{stringliteral}{"{}element-\/wise maximum"{}});}
\DoxyCodeLine{229   }
