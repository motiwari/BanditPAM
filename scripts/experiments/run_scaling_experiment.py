...
def main():
    run_sampling_complexity_experiment_with_n(MNIST,
                                              ...
                                              n_medoids=5, num_experiments=5)

    run_sampling_complexity_experiment_with_k(MNIST, n_medoids_list=[5, 10, 15], algorithms=ALL_BANDITPAMS,
                                              num_experiments=3)

    run_sampling_complexity_experiment_with_n(MNIST,
                                              num_data_list=np.linspace(10000, 70000, 5).astype(int),
                                              n_medoids=10, num_experiments=3, algorithms=ALL_BANDITPAMS, )
