def print_results(kmed, runtime):
    ...
    print("Average Swap Sample Complexity:", f'{kmed.swap_distance_computations / kmed.steps:,}')
    print("Total complexity (without misc):", f'{kmed.getDistanceComputations(False):,}')
    print("Total complexity (with misc):", f'{kmed.getDistanceComputations(True):,}')
