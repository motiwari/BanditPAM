...
def run_sampling_complexity_experiment_with_k(
    dataset_name,
    n_medoids_list=None,
    algorithms=None,
    loss: str = "L2",
...
def run_sampling_complexity_experiment_with_n(
    dataset_name,
    num_data_list,
    n_medoids,
    algorithms=None,
    ...
    for experiment_index in range(num_experiments):
        for num_data in num_data_list:
            ...
            for algorithm in algorithms:
                ...
                kmed, runtime = run_banditpam(
                    algorithm, data, n_medoids, loss, cache_width
                )
...
def main():
    run_sampling_complexity_experiment_with_n(
        CIFAR,
    ...
    run_sampling_complexity_experiment_with_k(
        CIFAR,
        n_medoids_list=[7],
        algorithms=ALL_BANDITPAMS,
        num_experiments=5,
