/**
 * @file banditpam_v3.cpp
 * @date 2021-07-25
 *
 * Contains the primary C++ implementation of the BanditPAM_v3 code.
 */
...
#pragma omp parallel for
    ...
    arma::urowvec medoidIndices(nMedoids);
      BanditPAM_v3::build(data, distMat, &medoidIndices, &medoidMatrix);
    steps = 0;
  ...
  arma::frowvec BanditPAM_v3::buildSigma(
...
#pragma omp parallel for
  ...
  arma::frowvec BanditPAM_v3::buildTarget(
      const arma::fmat& data,
      std::optional<std::reference_wrapper<const arma::fmat>> distMat,
...
#pragma omp parallel for
  ...
  arma::fmat BanditPAM_v3::swapSigma(
      const arma::fmat& data,
      std::optional<std::reference_wrapper<const arma::fmat>> distMat,
      const arma::frowvec* bestDistances,
...
#pragma omp parallel for
  ...
  arma::fvec BanditPAM_v3::swapTarget(
      const arma::fmat& data,
      std::optional<std::reference_wrapper<const arma::fmat>> distMat,
